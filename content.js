...
function applyState(minimized) {
    ...
    if (buttonElement) {
        buttonElement.innerHTML = minimized ? getExpandSvg() : getMinimizeSvg();
...
function createTooltip() {
    ...
    tooltipElement.style.cssText = [
        ...
        'transform:translateY(-50%) scale(0.95)', 'transform-origin:left center',
...
function injectNativeHeaderToggleButton() {
    ...
    if (!buttonElement) {
        ...
        buttonElement.innerHTML = isMinimized ? getExpandSvg() : getMinimizeSvg();
